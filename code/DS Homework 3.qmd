...
They did a regression with the plant-pollinator asynchrony against the year. The predictor variable is the indication that species shoe response diversity or differential changes th their asunchrony with apple bloom over time.
